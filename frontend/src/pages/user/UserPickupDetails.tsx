    ...
    <div className="min-h-screen pb-8">
      ...
      <div className="max-w-350 mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-white mb-2">Pickup Request Details</h1>
          <p className="text-white/60">View and manage your pickup request</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
                ...
                <div className="flex-1">
                  ...
                  {pickup.status === "rejected" && pickup.rejection_reason && (
                    <div className="mt-4 p-4 bg-white/5 border border-white/10 rounded-lg">
                      <p className="text-sm text-white/60 mb-1 font-semibold">Reason:</p>
                      <p className="text-white">{pickup.rejection_reason}</p>
                    </div>
                  )}
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                {pickup.image_url && (
                  <div className="p-4 bg-white/5 rounded-lg">
                    <p className="text-sm text-white/60 mb-3">Item Photo</p>
                    <img
                ...
                <div className="flex items-center justify-between gap-4 p-4 bg-white/5 rounded-lg">
                  <div>
                    <p className="text-sm text-white/60 mb-1">Preferred Date & Time</p>
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            {pickup.status === "accepted" && pickup.points_awarded && (
              <SpotlightCard className="bg-gradient-to-br from-green-500/10 to-green-600/5 backdrop-blur-xl border border-green-500/20 rounded-xl p-6 text-center">
                <div className="text-5xl mb-4">🎉</div>
                <h3 className="text-lg font-semibold text-white mb-2">Points Awarded</h3>
                <p className="text-5xl font-bold text-green-400 mb-3">+{pickup.points_awarded}</p>
                <p className="text-sm text-green-300/80">Thank you for recycling!</p>
              </SpotlightCard>
            )}
            ...
            {pickup.status === "open" && (
              <SpotlightCard className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl p-6">
                ...
                <button
                  ...
                  disabled={deleting}
                  className="w-full px-6 py-3 bg-red-500/20 hover:bg-red-500/30 border border-red-500/30 text-red-300 font-semibold rounded-lg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                >
                  {deleting ? (
                    <>
            ...
            <SpotlightCard className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl p-6">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-sm text-white font-mono">{pickup.id}</p>
                </div>
                <div>
