    ...
    <div className="min-h-screen pb-8">
      ...
      <div className="max-w-350 mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12">
        ...
        <div className="mb-8">
          ...
          <p className="text-white/60">Manage your e-waste pickup requests and track their status</p>
        </div>
        ...
        {pickups.length > 0 && (
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-8">
            ...
            <SpotlightCard className="bg-linear-to-br from-blue-500/10 to-blue-600/5 backdrop-blur-xl border border-blue-500/20 rounded-xl p-6 hover:shadow-xl hover:shadow-blue-500/10 transition-all duration-300">
              ...
              <p className="text-sm text-white/50 mb-1 font-medium">Open Requests</p>
              <p className="text-3xl font-bold text-white">{openRequests}</p>
            </SpotlightCard>
            ...
            <SpotlightCard className="bg-linear-to-br from-green-500/10 to-green-600/5 backdrop-blur-xl border border-green-500/20 rounded-xl p-6 hover:shadow-xl hover:shadow-green-500/10 transition-all duration-300">
              ...
              <p className="text-sm text-white/50 mb-1 font-medium">Completed</p>
              <p className="text-3xl font-bold text-white">{acceptedRequests}</p>
            </SpotlightCard>

            {/* Total Points */}
            <SpotlightCard className="bg-linear-to-br from-purple-500/10 to-purple-600/5 backdrop-blur-xl border border-purple-500/20 rounded-xl p-6 hover:shadow-xl hover:shadow-purple-500/10 transition-all duration-300">
              <div className="flex items-center justify-between mb-4">
        ...
        <div>
          <div className="flex items-center justify-between mb-6">
            ...
            {pickups.length > 0 && (
              <span className="text-sm text-white/60 font-medium">{pickups.length} total</span>
            )}
          </div>
          ...
          {loading ? (
            <SpotlightCard className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl p-8">
              <div className="flex flex-col items-center justify-center">
                ...
                <p className="text-white/60 font-medium">Loading your requests...</p>
              </div>
            </SpotlightCard>
          ) : pickups.length === 0 ? (
            <SpotlightCard className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl p-8 sm:p-12">
              <div className="flex flex-col items-center justify-center text-center">
                ...
                <h3 className="text-xl font-bold text-white mb-2">No Pickup Requests Yet</h3>
